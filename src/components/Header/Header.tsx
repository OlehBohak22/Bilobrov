      ...
      <Layout>
        <div className={s.headerTopLine}>
          <div className="flex gap-[4.8vw] lg:gap-[1.6vw]">
            ...
            {isMobile && (
              <button className={s.profile} onClick={openRegister}>
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className={s.headerLogo}>
              {isMobile ? (
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clipPath="url(#clip0_3760_24811)">
                    <path
              ...
              <ul className={s.navMenu}>
                {menuTree.map((item) => {
                  ...
                  if (modifiedUrl.endsWith("support")) {
                    ...
                    modifiedUrl.endsWith("podarunkovi-sertyfikaty-20")
                  ) {
                    modifiedUrl = "podarunkovi-sertyfikaty-20";
                  } else {
